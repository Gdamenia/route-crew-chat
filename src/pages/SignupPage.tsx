    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6 page-enter">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <RouteInput label={t('auth.password')} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Min 6 characters" showPasswordToggle autoComplete="new-password" required />
          <RouteInput label={t('auth.confirmPassword')} value={confirm} onChange={(e) => setConfirm(e.target.value)} placeholder="••••••••" showPasswordToggle autoComplete="new-password" required />
